...
{
    internal class btnCreateThiessenPolygons : Button
    {
        ...
        private async void OpenCreateThiessenPolygons()
        {
            ...
            Geoprocessing.OpenToolDialog("CreateThiessenPolygons_analysis", null, environments, true, null);
        }
    }
}
