...
using ProConfiguration_IntelShipSpaceAnalys.UI;
...
namespace ProConfiguration_IntelShipSpaceAnalys
{
    internal class ConfigurationManager1 : ConfigurationManager
    {
        ...
        protected override ImageSource Icon
        {
            get
            {
                return new BitmapImage(new Uri(@"pack://application:,,,/ProConfiguration_IntelShipSpaceAnalys;component/Images/favicon.ico"));
            }
        }
        ...
        protected override System.Windows.FrameworkElement OnShowStartPage()
        {
            ...
            //string project = ProConfigHelper.GetInitInfoConfig().DefaultProject;
            string project = ConstDefintion.ConstPath_DefaultProjectPath;
            var page = new StartPage(project);
